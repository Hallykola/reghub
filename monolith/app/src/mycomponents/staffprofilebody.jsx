...
class StaffProfileBody extends Component {
    state = {  myform:{} } 

    handleSubmit = (e)=>{
      e.preventDefault();
      var atoken = localStorage.getItem('token');
      const baseURL = process.env.REACT_APP_AUTH_BACKEND ; //"http://localhost:8001/auth/login/" ; //
...
export default StaffProfileBody;